...
import { Megaphone, BookOpen, MapPin, Calendar, Briefcase, Bot, Clock, CheckCircle, GraduationCap } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 pb-6">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-600/90 via-indigo-600/80 to-brand-600/90 p-8 shadow-2xl shadow-teal-500/20 border border-white/10"
      >
          ...
          <div className="flex-grow">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-4">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold bg-white/15 text-white px-3 py-1.5 rounded-full border border-white/20">
                ...
                {user?.department?.name || 'Faculty'} Department
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-bold bg-white/15 text-white px-3 py-1.5 rounded-full border border-white/20">
        ...
        <div className="relative mt-6 pt-5 border-t border-white/15">
          <p className="text-white/60 text-sm font-medium">{getGreeting()}, Professor</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
          ...
          <p className="text-xs font-bold text-light-muted dark:text-dark-muted uppercase tracking-wider mb-1">Faculty Name</p>
